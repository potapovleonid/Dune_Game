...
public class Tank extends GameObject {
    ...
    public void fire() {
        ...
        gc.getProjectilesController().setup(tmp, angle + 5);
        gc.getProjectilesController().setup(tmp, angle + 10);
        gc.getProjectilesController().setup(tmp, angle + 15);
        gc.getProjectilesController().setup(tmp, angle + 20);
        gc.getProjectilesController().setup(tmp, angle - 5);
        gc.getProjectilesController().setup(tmp, angle - 10);
        gc.getProjectilesController().setup(tmp, angle - 15);
        gc.getProjectilesController().setup(tmp, angle - 20);
